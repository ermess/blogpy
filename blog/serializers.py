...
class SubmitArticleSerializer(serializers.Serializer):
    ...
    cover = serializers.CharField(required=True, allow_null=False, allow_blank=False, max_length=256)
    content = serializers.CharField(required=True, allow_null=False, allow_blank=False, max_length=2048)
    category_id = serializers.IntegerField(required=True, allow_null=False, allow_blank=False)
    author_id = serializers.IntegerField(required=True, allow_null=False, allow_blank=False)
    promote = serializers.BooleanField(required=True, default=False, allow_null=False)
